...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","The_Caption_XD")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","TP_SAM_OP")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","TP_SAM_NETWORK")
BOT_NAME = os.environ.get("BOT_NAME","CHATBOT")
START_IMG = os.environ.get("START_IMG","https://graph.org/file/733804ba80d102cfd19ed.jpg")
...
SOURCE = 'https://github.com/Samdaveloper/Isha_chat_bot'
x=["❤️","🎉","✨","🪸","🎉","🎈","🎯"]
g=choice(x)
...
@Mukesh.on_message(filters.command(["I",f"start@{BOT_USERNAME}"]))
